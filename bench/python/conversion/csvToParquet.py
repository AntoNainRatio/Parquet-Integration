...
if __name__ == "__main__":
    ...
    csv_file = "C:/Users/KXFJ3896/Documents/parquet_reader/data/acci.csv"
    parquet_file = "C:/Users/KXFJ3896/Documents/parquet_reader/data/acci.parquet"

    #csv_file = os.path.join(kh.get_samples_dir(), "AccidentsMedium", "Places.txt")
    #parquet_file = os.path.join(kh.get_samples_dir(), "AccidentsMedium", "Places.parquet")
    verbose = False
