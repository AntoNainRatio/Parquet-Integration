...
extern "C"
{
	...
	VISIBLE long long int driver_getFileSize(MultiFile* multifile);
	...
	VISIBLE long long int driver_fread(void* ptr, size_t size, size_t count, void* multifile);

	// Returns 0 on success, -1 on error
	// Supports files larger than 4 Gb
	VISIBLE int driver_fseek(void* multifile, long long int offset, MultiFileWhence whence);
